...
# DICA: VEJA SOBRE FUNÇÃO REPLACE(), LOWER() E UMA FORMA DE INVERTER OS CARACTERES.
...
# .replace() faz com que subistitua o primeiro item pelo segundo, por exemplo nessa linha estou subistituindo qualquer "espaço" por "nada" .replace(" ", "")
